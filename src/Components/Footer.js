    ...
    function IconHeart() {
        return (
            <div onClick={() => setClickedHeart(!clickedHeart, changeCount())} className="c-post__icon">
                {clickedHeart ? <ion-icon name="heart-outline"></ion-icon> : <ion-icon name="heart" style={{ color: "#ED4957" }}></ion-icon>}
            </div>
        );
    };
        ...
        <>
            <div className="c-post__footer">
                ...
                <div className="u-center-x u-display-flex">
                    ...
                    />
                    <p>Curtido por <b>daniel__bernardino</b> e <b>outras {liked.toLocaleString("pt-BR")} pessoas</b></p>
                </div>
            </div>
        </>
    )
